      ...
      <div class="flex justify-center flex-col mt-12">
        ...
        <div class="flex justify-center">
          <button
            ...
            class="my-5 mt-12 bg-yellow-500 rounded-2xl p-3 font-bold text-xl shadow-lg group hover:outline-4 hover:outline-red-200 hover:bg-gradient-to-br hover:from-fuchsia-600 hover:to-orange-600 transition-all ease-in duration-75"
          >
            HOME
          </button>
        </div>
